...
But in a suprisingly short amount of time it's become something that I find myself running _toward_.  
...
But the flip side of that is that I don't always catch my mistakes, and I often spend _a lot_ of time figuring out how to fix my mistakes. 
And the cost? 
...
And I _learned_ so much in such a short span of time -- more than I would have if I sat down and tried to do it solo.
...
There are _definitely_ some issues with this plot! 
...
```{r echo = FALSE}
blogdown::shortcode('tweet', '1402263889543319562')
```
...
```{r echo = FALSE}
blogdown::shortcode('tweet', '1402274189789339662')
```

As always, #TidyTuesday Unfiltered is intended to get you _started_ with a plot, but is never meant to be the final plot! 
