...
blogdown::shortcode("youtube", "6M8szlSa-8o")
```
...
And if you look online everyone it can feel like everyone is talking about how _easy_ Python is, and how elegant and beautiful it is, and it just kind of makes me feel worse for not "getting it" when I so desperately _want_ to "get it" and am _actively trying_ to "get it."
...
Except that I want to take my career in a direction that relies heavily on knowing both Python and R, _and_ because I think that there's inherent value in knowing both languages.
...
**Know what you're trying to learn, and remember _why_ you're learning**
...
It can also be helpful to look at what you're trying to learn, and determine if you're starting at something too far outside of your learning zone.
...
**Remind yourself (often) that you're _really good_ at things!**
Whenever I get really frustrated with myself for not being great at Python (yet) I take a moment to remember that there are things I'm really good at - like teaching, organizing curriculum, and public speaking. 
...
Start by reading [A Whirlwind Tour of Python](https://jakevdp.github.io/WhirlwindTourOfPython/), which assumes you can program in another language, and spends its time pointing out some of the landmarks that make Python different and unique. 
...
- Re-read the chapter (without coding) and annotate the chapter by highlighting vocabulary words, important concepts, and anything unfamiliar. Then research it while taking notes and drawing out diagrams to better understand the concepts.
- Review the code and start linking what the code is doing to chapter vocabulary and concepts, especially any illustrations that I've made.
...
- Use the chapter to re-create the analysis on a new dataset.
