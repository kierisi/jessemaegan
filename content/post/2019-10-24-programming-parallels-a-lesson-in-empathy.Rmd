...
There wasn't a "loose end" on my yarn for me to pick up and use, so I found myself Googling all manner of phrases to finding the starting end of a skein of yarn. It took awhile and required me to know whether or not I had what's called "center pull" yarn (I didn't, and it's not labeled on the skein, so I just assumed that I did and went with it - turns out I was right!) Cool, I've got the yarn, let's go!
