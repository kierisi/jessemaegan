...
![Highlighted code and package used to create a reprex](/jessemaegan/static/img/highlighted_reprex_code.png)
...
![Example reprex post using a ggplot2 example](/jessemaegan/static/img/ggplot2_reprex_image.png)
...
![non-formatted R code](static/img/non_reprex.png)

![R code formatted using reprex()](/static/img/reprex.png)
