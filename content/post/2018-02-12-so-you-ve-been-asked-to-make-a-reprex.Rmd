...
![Highlighted code and package used to create a reprex](/static/img/highlighted_reprex_code.png)
...
![Example reprex post using a ggplot2 example](/static/img/ggplot2_reprex_image.png)
