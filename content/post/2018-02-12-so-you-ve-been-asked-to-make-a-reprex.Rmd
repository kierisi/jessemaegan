...
Navigate to [community.rstudio.com](https://community.rstudio.com/) and create a new post. Paste (Ctrl + v/Cmd + v) your reprex into the posting box on the left and add any necessary commentary to help community members answer your question, like so:
...
Asking a question *with* a reprex is like asking, "My cake didn't turn out, and here's the recipe I used and the steps that I followed. Where did I go wrong?"  