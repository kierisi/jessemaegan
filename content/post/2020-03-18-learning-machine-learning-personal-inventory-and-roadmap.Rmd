...
![Drawing of a person staring at a bunch of clouds and asking "hey, uh, is it supposed to look like this?"](/post/2020-03-18-learning-machine-learning-personal-inventory-and-roadmap_files/what_is_this.jpg){width=650px}
...
And on the one hand this seems somewhat reasonable, because you'll know everything that's out there before committing your resources to a specific win condition. 
This strategy isn't unlike the procrastiplanning I'm guilty of.
Rather than jumping in and trying to learn something, I can spend weeks and even months charting out the perfect learning path.
...
![A drawing of a person standing in front of a large, complex Venn diagram](/post/2020-03-18-learning-machine-learning-personal-inventory-and-roadmap_files/venn_diagram_use.jpg){width=650px}
...
Instead I have a couple of general landmarks that I know I want to work towards, and a good understanding of where I'm starting.

What changed for me was encountering two resources that cleared some of the fog from my landmarks.
...
I learned about the NSynth Super from this [Nat & Friends](https://www.youtube.com/channel/UCf4AIjSwE-E2TggCPdm-z-A) video, and as soon as the video was finished playing I was hooked - I _needed_ to learn how to do this.
...
![Drawing of a person standing in front of a landscape. In the foreground is a path that says Python, and it leads to two mountains, one labeled "deep learning" and another labeled "Magenta." There are also unlabeled peaks, and text across the distant horizon says "cool things I don't even know that I don't know!" Many parts of the path are obscured by trees and clouds.](/post/2020-03-18-learning-machine-learning-personal-inventory-and-roadmap_files/single_player.jpg){width=650px}
...
Sometimes you're going to have to learn on your own, but as often as possible, reach out to your community.
...
![Drawing of a person standing in front of supportive text messages that say things like "Keep going!" and "Psst! I have memes!" and "Be careful! That spot can be challenging."](/post/2020-03-18-learning-machine-learning-personal-inventory-and-roadmap_files/multiplayer_use.jpg){width=650px}

## Learn With Me!
Every week I'll be posting a round-up of my learning journey. I'll be sharing:
